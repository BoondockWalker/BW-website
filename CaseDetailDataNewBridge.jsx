  ...
  blocks: [
    ...
    /* -- Website — 4 site pages ---------------------------------- */
    {
      ...
      items: [
        ...
        { src: `${NB_BASE}/site-history.png`, alt: "NewBridge website — History",         caption: "fig. 08.3 · History", width: 1100, bg: "#FBF7EE" },
        { src: `${NB_BASE}/site-gallery.png`, alt: "NewBridge website — Gallery",         caption: "fig. 08.4 · Gallery", width: 1100, bg: "#FBF7EE" },
      ],
    },
