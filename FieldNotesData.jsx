...
const FN_AUTHORS = {
  "B. Walker":  { initials: "BW", role: "Principal" },
...
const FN_NOTES = [
  { slug: "seven-years-unagency",     issue: "No 19", date: "May 09 · 2026", kicker: "Operator's diary",   title: "Seven years unagency. What we learned, what's next.", dek: "We bet on a model. The bet paid. The next one is bigger.", author: "B. Walker",  minutes: 4, tag: "Voice",    art: "compass",  size: "L", featured: true },
  { slug: "stop-calling-it-heritage", issue: "No 18", date: "Apr 22 · 2026", kicker: "Voice / Long read",   title: "The year you stop calling it heritage.",         dek: "A 70-year wholesale brand has more in common with a startup than it thinks. The receipts of having survived are an asset operators buy — but only if you stop apologizing for the year on the door.", author: "B. Walker",  minutes: 9, tag: "Voice",    art: "voice",    size: "L" },
  ...
  { slug: "category-of-one",          issue: "No 15", date: "Mar 11 · 2026", kicker: "Positioning",        title: "Category of one — without a category.",           dek: "If your buyer doesn't have a name for what you do, you can't be searched. So name it.", author: "B. Walker",  minutes: 5, tag: "Brand",    art: "compass",  size: "S" },
  ...
  { slug: "founder-deck-anti",        issue: "No 10", date: "Dec 17 · 2025", kicker: "Brand · Receipts",   title: "The founder deck anti-pattern.",                  dek: "When the founder closes their own deals, the deck is right. When the team can't, the deck is a feeling.", author: "B. Walker",  minutes: 6, tag: "Brand",    art: "compass",  size: "L" },
  ...
  { slug: "rebrand-vs-refit",         issue: "No 06", date: "Oct 22 · 2025", kicker: "Brand",              title: "Rebrand vs. refit — and how to tell.",            dek: "Most rebrands should have been refits. A four-question test before the budget locks.", author: "B. Walker",  minutes: 5, tag: "Brand",    art: "compass",  size: "S" },
  ...
  { slug: "pipeline-honest-metric",   issue: "No 03", date: "Sep 10 · 2025", kicker: "Demand · Voice",     title: "Pipeline is the only honest metric.",             dek: "Awareness, engagement, sentiment — fine. But you eat what you close.", author: "B. Walker",  minutes: 5, tag: "Demand",   art: "pipeline", size: "L" },
  { slug: "field-manual-launch",      issue: "No 02", date: "Aug 27 · 2025", kicker: "Bureau",             title: "We started a field manual.",                      dek: "Why the bureau is publishing notes again, twice a month, no email gate.", author: "B. Walker",  minutes: 3, tag: "Voice",    art: "voice",    size: "S" },
