...
const FN_NOTES = [
  ...
  { slug: "brand-foundations-fail-tuesday", issue: "No 21", date: "May 20 · 2026", kicker: "Brand / Long read", title: "Most brand foundations fail on a Tuesday.", dek: "Built to win the presentation. Not to survive the workday.", author: "M. Nead",  minutes: 5, tag: "Brand",    art: "tuesday",  size: "L", image: "assets/field-notes/brand-foundations-fail-tuesday.webp", imageAlt: "Five weekday bars on a brown ground — Tuesday's bar fractures and the rest tilt off-baseline" },
