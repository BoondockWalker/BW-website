...
window.BW_CASE_DETAIL = {
  ...
  hero: {
    ...
    clientLogoHeight: 96,
    standfirst: "O'Neil Digital Solutions is a premier provider of digital transformation and customer communication services, with over 60 years of commitment to innovative solutions. Standing at the forefront of technology, O'Neil continues to offer scalable solutions that dynamically respond to client needs.",
  },
  ...
  blocks: [
    ...
    /* -- Corporate Website — full bleed ---------------------------- */
    {
      ...
      caption: { label: "fig. 04 · Corporate Website", title: "ONeilDigitalSolutions.com — full responsive build" },
    ...
    /* -- Brochure spread — full bleed ------------------------------ */
    {
      kind: "fullbleed",
      src: `${BASE}/brochure-spread.jpg`,
      alt: "ONEsuite brochure — Jack & Jackie sales collateral spread",
      caption: { label: "fig. 05 · Sales Collateral", title: "Know Jack & Jackie — ONEsuite 4.0 brochure" },
      height: "min(78vh, 760px)",
      surface: BW_CHALK_50(),
      parallax: 60,
    },
