...
function FNArt({ kind, color, caption, label, image, alt }) {
  ...
  else if (kind === "tuesday") glyph = (<g>{/* Five weekday bars on a chalk strip — Tuesday's bar fractures, the foundation slips after. */}<line x1="22%" y1="34%" x2="78%" y2="34%" stroke={BW.chalk50} strokeWidth="0.6" opacity="0.4" /><line x1="22%" y1="74%" x2="34%" y2="74%" stroke={BW.chalk50} strokeWidth="0.6" opacity="0.4" /><line x1="44%" y1="78%" x2="78%" y2="78%" stroke={BW.chalk50} strokeWidth="0.6" opacity="0.4" /><line x1="22%" y1="40%" x2="22%" y2="68%" stroke={BW.chalk50} strokeWidth="3" strokeLinecap="square" /><line x1="34%" y1="40%" x2="34%" y2="52%" stroke={BW.chalk50} strokeWidth="3" strokeLinecap="square" /><line x1="40%" y1="58%" x2="40%" y2="72%" stroke={BW.chalk50} strokeWidth="3" strokeLinecap="square" /><line x1="51%" y1="40%" x2="51%" y2="72%" stroke={BW.chalk50} strokeWidth="3" strokeLinecap="square" opacity="0.85" /><line x1="63%" y1="40%" x2="63%" y2="74%" stroke={BW.chalk50} strokeWidth="3" strokeLinecap="square" opacity="0.78" /><line x1="76%" y1="40%" x2="76%" y2="76%" stroke={BW.chalk50} strokeWidth="3" strokeLinecap="square" opacity="0.72" /></g>);
  return (
